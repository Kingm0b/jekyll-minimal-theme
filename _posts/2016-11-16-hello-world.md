...
Para postar algo, devo escrever um arquivo de extensão .md ou .markdown e colocá-lo no subdiretório <code>_posts</code>. O nome deste arquivo não pode ser qualquer coisa, ele **deve** ser a data do post no formato YYYY-MM-DD seguido do nome do futuro arquivo html gerado.

Exemplo: **2016-12-28-hello-world.md**
